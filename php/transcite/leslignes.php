...
/*
 * apelle de ./bdd/requettes.php Ligne 70
 * envoie la connexion et
 * retourne la table complète de Lignes avec une colonne "Count" qui est le nombre de ligne
 */
$lignes = leslignes($bdd);
    ...
    <div class="container-fluid py-5">
        <section>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                -->
                <h1>Liste des Lignes <?php echo $lignes[0]['Count'] ?></h1>
            </div>
            <div class="row">
